	...
	<body class="w3-light-grey">
		...
		<div class="w3-content" style="max-width:1600px">
			...
			<header class="w3-container w3-center w3-padding-48 w3-white">
				<h1 class="w3-xxxlarge"><b>Noticias rechazadas</b></h1>
				<h6>Aquí figuran las noticias rechazadas por los administradores de <span class="w3-tag">Infonete S.A.</span></h6>
			</header>
