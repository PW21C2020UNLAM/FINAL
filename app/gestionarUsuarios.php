						...
						<div class="w3-padding-32 w3-center w3-row">			
							<div class="w3-container  w3-padding w3-light-grey w3-margin-top ">
								<div class="w3-container w3-black">
									<h2 class="w3-lobster">Ingrese el nombre del usuario para eliminarlo del sistema</h2>
								</div>   
								<form action="validarEliminarCuentaAdmin.php" method="post" enctype="application/x-www-form-urlencoded"><br><br>
									<label class="w3-text-brown">Ingrese usuario:</label> <input class="w3-input w3-border w3-sand" type="text" name="usr" required><br><br>
									<label class="w3-text-brown">Ingrese su clave de administrador:</label> <input class="w3-input w3-border w3-sand" type="password" name="clave" required><br><br>
