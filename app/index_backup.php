...
<html>
	...
	<body class="w3-light-grey">
		...
		<div class="w3-bar w3-black w3-hide-small">
			<a href="iniciarSesion.php" class="w3-bar-item w3-button"><?php echo $user?></a>
		...
		<div class="w3-content" style="max-width:1600px">
			...
			<header class="w3-display-container w3-wide" id="home">
				<img class="w3-image" src="./imagenes/jane.jpg" alt="Fashion Blog" width="1600" height="1060">
			...
			<div class="w3-row w3-padding w3-border">
				...
				<div class="w3-container w3-white w3-margin w3-padding-large">
					...
					<div class="w3-justify">
						<img src="./imagenes/girl_hat.jpg" alt="Girl Hat" style="width:100%" class="w3-padding-16">
						...
						<div class="w3-row w3-margin-bottom" id="demo1" style="display:none">
							...
							<div class="w3-col l2 m3">
								<img src="./imagenes/avatar_smoke.jpg" style="width:90px;">
							</div>
				...
				<div class="w3-container w3-white w3-margin w3-padding-large">
					...
					<div class="w3-justify">
						<img src="./imagenes/man_hat.jpg" alt="Men in Hats" style="width:100%" class="w3-padding-16">
						...
						<div id="demo2" style="display:none">
							<div class="w3-row">
								<hr>
								<div class="w3-col l2 m3">
									<img src="./imagenes/girl_train.jpg" style="width:90px;">
								</div>
								<div class="w3-col l10 m9">
							...
							<div class="w3-row w3-margin-bottom">
								<div class="w3-col l2 m3">
									<img src="./imagenes/girl.jpg" style="width:90px;">
								</div>
								<div class="w3-col l10 m9">
				...
				<div class="w3-container w3-white w3-margin w3-padding-large">
					...
					<div class="w3-justify">
						<img src="./imagenes/runway.jpg" alt="Runway" style="width:100%" class="w3-padding-16">
						...
						<div id="demo3" style="display:none">
							...
							<div class="w3-row w3-margin-bottom">
								<div class="w3-col l2 m3">
									<img src="./imagenes/girl_mountain.jpg" style="width:90px;">
								</div>
								<div class="w3-col l10 m9">
							...
							<div class="w3-row w3-margin-bottom">
								<div class="w3-col l2 m3">
									<img src="./imagenes/boy.jpg" style="width:90px;">
								</div>
								<div class="w3-col l10 m9">
							...
							<div class="w3-row w3-margin-bottom">
								<div class="w3-col l2 m3">
									<img src="./imagenes/girl_hood.jpg" style="width:90px;">
								</div>
								<div class="w3-col l10 m9">
				...
				<div class="w3-col l4">
					...
					<div class="w3-white w3-margin">
						...
						<div class="w3-row-padding w3-white">
							<div class="w3-col s6">
								<p><img src="./imagenes/jeans.jpg" alt="Jeans" style="width:100%"></p>
								<p><img src="./imagenes/team1.jpg" alt="Jeans" style="width:100%"></p>
							</div>
							<div class="w3-col s6">
								<p><img src="./imagenes/avatar_hat.jpg" alt="Men in Hats" style="width:100%" class="w3-grayscale"></p>
								<p><img src="./imagenes/team4.jpg" alt="Jeans" style="width:100%"></p>
							</div>
						</div>
					</div>
					<hr>
