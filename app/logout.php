				...
				<div class="w3-padding-32 w3-center w3-row">			
					<div class="w3-container  w3-padding w3-light-grey w3-margin-top ">
						<div class="w3-container w3-black">
							<h2 class="w3-lobster">Ha finalizado la sesión</h2>
						</div>
						<br><label class="w3-text-brown">Si lo desea, puede iniciar sesión nuevamente.</label><br><br>
							<a href="iniciarSesion.php">
								<input class="w3-btn w3-black" type="submit" value="Iniciar Sesión">
							</a>
					</div>
				</div> 
			</div>
