        ...
        <div class="w3-padding-32 w3-center w3-row">
            <div class="w3-container  w3-padding w3-light-grey w3-margin-top ">
                <div class="w3-container w3-black">
                    <h2 class="w3-lobster">
                        <?php
                        if(isset($_POST['nombreForm'])&&(isset($_FILES['imagenForm'])&&$_FILES['imagenForm']['error']==0)){
                            echo subirPublicacion($_POST['nombreForm'],$_FILES['imagenForm']['tmp_name']);
                            $subidaExitosa=true;
                        }else{
                            echo "ERROR";
                        }
                ...
                <?php
                if(!$subidaExitosa){
                    echo '<br><br></h2><a href="cargarNuevaPublicacion.php"><input class="w3-btn w3-black" type="submit" value="Reintentar"></a>';
                }else{
