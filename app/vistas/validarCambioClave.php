<?php
	...
	if(!esUsuarioValido($_SESSION['usuario'],$_SESSION['clave']) || (!isset($_POST['claveActual'])||!isset($_POST['claveNueva']))){
		header("Location: ../index.php");
	}
	$resultadoCambioClave=false;
?>
							...
							<div class="w3-container  w3-padding w3-light-grey w3-margin-top ">
								<div class="w3-container w3-black">
									...
									<?php
										...
										$user = $_SESSION['usuario'];
										$resultadoCambioClave=cambiarClave($claveActual,$claveNueva,$user);
										if($resultadoCambioClave){
											echo "¡Clave cambiada exitosamente!";
											$_SESSION['clave']=$claveNueva;
										}else{
											echo "Error al actualizar la clave. Intente de nuevo.";
										}
									?>
								</div>
                            </div>
