							...
							<div class="w3-container  w3-padding w3-light-grey w3-margin-top ">
								<div class="w3-container w3-black">
									...
									<?php
										$clave = $_POST['clave'];
										$user = $_SESSION['usuario'];
										$resultadoBorrarUsuario=eliminarCuenta($user,$clave);
										if($resultadoBorrarUsuario){
											echo "El usuario ha sido eliminado exitosamente. Esperamos volver a verte.";
											session_destroy();
										}else{
											echo "Error al eliminar su cuenta. Intente de nuevo.";
										}
									?>
								</div>
								<?php
									if(!$resultadoBorrarUsuario){
										echo '<br><br></h2><a href="eliminarCuenta.php"><input class="w3-btn w3-black" type="submit" value="Reintentar"></a>';
									}else{
										echo '<br><br></h2><a href="../index.php"><input class="w3-btn w3-black" type="submit" value="Volver al inicio"></a>';
									}
								?>
							</div>
						</div> 
