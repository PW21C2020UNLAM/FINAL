						...
						<div class="w3-padding-32 w3-center w3-row">			
							<div class="w3-container  w3-padding w3-light-grey w3-margin-top ">
								<div class="w3-container w3-black">
									<h2 class="w3-lobster">Registro</h2>
								</div>
								<form action="validarRegistro.php" method="post" enctype="application/x-www-form-urlencoded"><br><br>
									...
									<label class="w3-text-brown">Mail:</label> <input class="w3-input w3-border w3-sand" type="text" name="mail" required><br><br>
									<input class="w3-btn w3-black" type="submit" value="Enviar"><br><br>
									<a href="iniciarSesion.php">¿Ya estás registrado?</a>
