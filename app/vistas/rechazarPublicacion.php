        ...
        <div class="w3-padding-32 w3-center w3-row">
            <div class="w3-container  w3-padding w3-light-grey w3-margin-top ">
                <div class="w3-container w3-black">
                    <?php moverPublicacion($_POST['fileNameJPG'], $_POST['estado']); ?>
                    <h2 class="w3-lobster">Publicación RECHAZADA...</h2>
                </div>
                <br><label class="w3-text-brown">Para seguir gestionando publicaciones, click en el botón de abajo</label><br><br>
                <a href="publicacionesPendientes.php">
